    ...
    <>
      ...
      <div className="wrapper">
        ...
        <p>
          ...
          ones that are interesting by clicking the checkbox in the corner of each
          buyer.
        </p>
            ...
            <div className={styles.content} key={buyer.id}>
              ...
              <pre>
                ...
                <div className={styles.icontext}>
                  ...
                  <p><strong>Max price:</strong> {buyer.maxPrice} DKK</p>
                </div>
                ...
                <div className={styles.icontext}>
                  ...
                  <p><strong>Minimum size:</strong> {buyer.minSize} m2</p>
                </div>
                ...
                <div className={styles.icontext}>
                  ...
                  <p><strong> People in household:</strong> {buyer.adults} adults and{" "}
                ...
                <path fill-rule="nonzero" stroke="currentColor" stroke-width="2" d="M12 18.573l6.894-7.015a3.898 3.898 0 0 0 0-5.44 3.698 3.698 0 0 0-5.298 0L12 7.742l-1.596-1.624a3.698 3.698 0 0 0-5.298 0 3.898 3.898 0 0 0 0 5.44L12 18.573z"/>
                </svg>

                  <p><strong>About:</strong> {buyer.description}</p>
                </div>
                ...
                <div className={styles.icontext}>
                  ...
                  <p><strong>Estate type:</strong> {buyer.estateType}</p>
                </div>
                ...
                <div className={styles.icontext}>
                  ...
                  <p><strong>Possible take-over-date:</strong> {buyer.takeoverDate}</p>
                </div>
              </pre>
